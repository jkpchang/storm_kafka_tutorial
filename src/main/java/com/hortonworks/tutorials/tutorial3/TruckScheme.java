...
public class TruckScheme implements Scheme {
  ...
  public List<Object> deserialize(byte[] bytes) {
    try {
      ...
      return new Values(cleanup(driverId), cleanup(truckId), eventTime, cleanup(eventType), cleanup(longitude),
          cleanup(latitude));
  ...
  public Fields getOutputFields() {
    return new Fields(FIELD_DRIVER_ID, FIELD_TRUCK_ID, FIELD_EVENT_TIME, FIELD_EVENT_TYPE, FIELD_LONGITUDE,
        FIELD_LATITUDE);
